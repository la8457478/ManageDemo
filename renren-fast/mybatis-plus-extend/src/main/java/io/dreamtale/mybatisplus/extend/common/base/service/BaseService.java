package io.dreamtale.mybatisplus.extend.common.base.service;
...
import io.dreamtale.mybatisplus.extend.common.exception.RRException;

@Transactional(
    rollbackFor = {RRException.class}
)
public abstract class BaseService<M extends BaseMapper<T>, T> implements IBaseService<T> {
    ...
    public boolean remove(Map<String,Object> params ) {
        return SqlHelper.retBool(this.baseMapper.delete(generateWrapper(params)));
    }
    ...
    public boolean update(T entity, Map<String,Object> params ) {
        return this.retBool(this.baseMapper.update(entity, generateWrapper(params)));
    }
    ...
    public T getOne(Map<String,Object> params , boolean throwEx) {

        return throwEx ? this.baseMapper.selectOne(generateWrapper(params)) : SqlHelper.getObject(this.log, this.baseMapper.selectList(generateWrapper(params)));
    }

    public Map<String, Object> getMap(Map<String,Object> params) {
        return (Map)SqlHelper.getObject(this.log, this.baseMapper.selectMaps(generateWrapper(params)));
    }

    public int count(Map<String,Object> params) {
        return SqlHelper.retCount(this.baseMapper.selectCount(generateWrapper(params)));
    }

    public List<T> list(Map<String,Object> params) {
        return this.baseMapper.selectList(generateWrapper(params));
    }

    public IPage<T> page(IPage<T> page, Map<String,Object> params) {
        return this.baseMapper.selectPage(page, generateWrapper(params));
    }

    public List<Map<String, Object>> listMaps(Map<String,Object> params) {
        return this.baseMapper.selectMaps(generateWrapper(params));
    }

    public <V> List<V> listObjs(Map<String,Object> params, Function<? super Object, V> mapper) {
        return (List)this.baseMapper.selectObjs(generateWrapper(params)).stream().filter(Objects::nonNull).map(mapper).collect(Collectors.toList());
    }

    public IPage<Map<String, Object>> pageMaps(IPage<T> page, Map<String,Object> params) {
        return this.baseMapper.selectMapsPage(page, generateWrapper(params));
    }

    public <V> V getObj(Map<String,Object> params, Function<? super Object, V> mapper) {
        return SqlHelper.getObject(this.log, this.listObjs(params, mapper));
    }
}
